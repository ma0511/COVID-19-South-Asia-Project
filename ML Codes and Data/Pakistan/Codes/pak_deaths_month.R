...
######### Pakistan (Sindh) Covid-19 Deaths Data
######### Updated Data 
#################################################################
################################################################# 
...
df1 <- df.pak %>%
  dplyr::select(deaths, district, month, year, index) %>%
...
control <- trainControl(method = "repeatedcv", number = 5, repeats = 3, search = "random", sampling = "down")
